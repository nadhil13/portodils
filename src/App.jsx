// src/App.jsx
import React, { useState, useEffect } from 'react'; // Impor useState
...
// Safe Spline Component dengan error handling yang lebih robust
const SafeSpline = ({ scene, className, ...props }) => {
  ...
  useEffect(() => {
    ...
    // Langsung load tanpa delay
    loadSpline();
  }, []);

  if (loading) {
    return (
      <div className={`${className} flex items-center justify-center bg-gray-900/20 rounded-lg`}>
        <div className="text-center text-gray-400">
          <div className="text-2xl mb-2 animate-pulse">⚡</div>
          <div className="text-sm">Loading 3D Robot...</div>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className={`${className} flex items-center justify-center bg-gray-900/20 rounded-lg`}>
        <div className="text-center text-gray-400">
          ...
          <div className="text-sm">3D Robot</div>
        </div>
      </div>
    );
  }
...
function App() {
  ...
  const stats = [
    ...
    { icon: <FaCertificate />, value: "17", title: "CERTIFICATES", description: "Professional skills validated" },
        ...
        <div className="relative min-h-screen bg-[#060010] overflow-hidden">
          ...
          <main className="relative z-10 px-8 max-w-7xl mx-auto">
            ...
            <section id="home" className="flex flex-col md:flex-row items-center gap-10 pt-20 pb-16 lg:pt-0 lg:pb-20">
              ...
              <div className="flex-1 text-white space-y-6 pt-16 md:pt-40 order-last md:order-none">
                ...
                <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 1.0, ease: "easeOut" }} className="flex flex-row gap-4 mt-8">
                    <a href="https://github.com/nadhil13" target="_blank" rel="noopener noreferrer" aria-label="GitHub Profile" className="group relative flex h-12 w-12 items-center justify-center rounded-full border border-slate-700 bg-slate-900/[0.8] text-white transition-all duration-300 hover:border-cyan-400 hover:bg-slate-800 hover:shadow-[0_0_24px_2px_#00ffdc]">
                        <FaGithub className="h-6 w-6 text-slate-400 transition-all duration-300 group-hover:text-cyan-300" />
                    </a>
                    <a href="https://instagram.com/_ndlasy" target="_blank" rel="noopener noreferrer" aria-label="Instagram Profile" className="group relative flex h-12 w-12 items-center justify-center rounded-full border border-slate-700 bg-slate-900/[0.8] text-white transition-all duration-300 hover:border-cyan-400 hover:bg-slate-800 hover:shadow-[0_0_24px_2px_#00ffdc]">
                        <FaInstagram className="h-6 w-6 text-slate-400 transition-all duration-300 group-hover:text-cyan-300" />
                    </a>
                    <a href="https://linkedin.com/in/muhammad-nadhil-arsy-al-wafi" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn Profile" className="group relative flex h-12 w-12 items-center justify-center rounded-full border border-slate-700 bg-slate-900/[0.8] text-white transition-all duration-300 hover:border-cyan-400 hover:bg-slate-800 hover:shadow-[0_0_24px_2px_#00ffdc]">
            ...
            >
              ...
              <div className="flex flex-col md:flex-row items-center justify-center">
                ...
                >
                  ...
                  <h3 className="text-4xl font-bold text-white my-2 font-moderniz" style={{ textShadow: "2px 2px 0 #000754, 4px 4px 0 #4079ff, 0 4px 12px #40ffaa, 0 1px 0 #00ffdc" }}>Muhammad Nadhil Arsy Al-Wafi</h3>
                  <p className="text-white/80 leading-relaxed mt-4 font-cascadia text-justify">
                    Saya adalah mahasiswa Teknik Informatika di Institut Teknologi Perusahaan Listrik Negara Jakarta dengan minat besar dalam pengembangan Fullstack Web Developer dan teknologi web modern. Saya selalu bersemangat untuk terus belajar dan mengembangkan kemampuan dalam menciptakan solusi digital yang inovatif untuk menghadapi tantangan dunia teknologi.
                  </p>
            ...
            <footer className="py-8 text-center text-gray-400">
              <div className="text-sm">© {new Date().getFullYear()} Muhammad Nadhil Arsy Al-Wafi. All rights reserved.</div>
